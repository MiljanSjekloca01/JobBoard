        ...
        @method('PUT')
            <div class="container m-auto grid grid-cols-2 gap-4 mb-4">
                ...
                <div>
                    ...
                    <x-radio-group name="experience" :value="$job->experience" :options="$experience" :showAllOption="false"/>
                </div>

                <div>
                    <x-label for="category" :required="true">Category</x-label>
                    <x-radio-group name="category" :value="$job->category" :options="$category" :show-all-option="false"/>
                </div>
